    ...
    <>
      <div className={`p-4 lg:p-6 flex items-center ${isSidebarCollapsed ? 'justify-center' : 'justify-between'}`}>
        <div className={`flex items-center gap-1.5 ${isSidebarCollapsed ? 'justify-center' : ''}`}>
          <img src="/watchtower-icon.png" alt="Watchtower" className="w-8 h-8 rounded-lg flex-shrink-0" />
          {!isSidebarCollapsed && <span className="font-semibold text-lg text-white">Watchtower</span>}
        </div>
        ...
        <div className={`sticky top-0 z-30 flex items-center justify-between px-3 py-2.5 border-b lg:hidden ${darkMode ? 'bg-slate-950 border-white/5' : 'bg-white border-slate-200'}`}>
          <div className="flex items-center gap-3">
            ...
            <div className="flex items-center gap-2">
              <img src="/watchtower-icon.png" alt="Watchtower" className="w-7 h-7 rounded-lg" />
              <span className="font-semibold text-base text-white">Watchtower</span>
            </div>
          </div>
          <button
            onClick={toggleTheme}
